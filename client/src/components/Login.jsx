    ...
    justify-center items-center'>
        ...
        className='relative bg-white p-10 rounded-xl text-slate-500'>
            ...
            { state != 'Login' && <div className='border px-6 py-2 flex items-center gap-2 rounded-full mt-5'>
                ...
                value={name} type="text" className='outline-none text-sm' 
            ...
            {state === 'Login' ? <p className='mt-5 text-center'>Dont have an acoount? 
                <span className='text-blue-600 cursor-pointer' onClick={()=>setState('Sign Up')}>
                    Sign up</span>
            </p>
            :
            <p className='mt-5 text-center'>Already have an acoount? 
